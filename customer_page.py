...
<style>
    ...
    /* Apply Poppins font to all body text, labels, buttons */
    html, body, .stApp, .stApp * {
        font-family: 'Poppins', sans-serif !important;
    }
    
    /* Apply Poppins to main title, headers, and prominent text */
    ...
    .hero-banner {
        ...
        margin-bottom: 2rem;
        background-image: url('https://d2xsxph8kpxj0f.cloudfront.net/310519663565725690/2DCu3E4GoUrCCQVZWimKAR/hero-coffee-bg-cxCNhywSdCWbxzxmF4g84J.webp');
...
def show_main_app():
    ...
    # Hero banner with welcome header and title
    st.markdown(f"""
    <div class="hero-banner">
        <div class="hero-content">
            <div class="welcome-text">Welcome back, {st.session_state.user_name}! </div>
            <div class="main-title" style="font-size: 2rem; white-space: nowrap;">Your Perfect Pairings</div>
            <div class="subtitle">Discover what foods pair perfectly with your favorite coffee</div>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    with col_step1:
        ...
        <div class="step-card">
            ...
            We analyse your full transaction history and find out the most frequently purchased coffee beverage. 
            </div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col_step2:
        ...
        <div class="step-card">
            ...
            <div class="step-description">
            We identify which foods customers 
    ...
    with col_step3:
        ...
        <div class="step-card">
            ...
            <div class="step-description">
            Every coffee has its own flavor (fruity, roasted, nutty, etc.). We pair it with foods that bring out its best flavors.
            </div>
        </div>
        """, unsafe_allow_html=True)
            ...
            if not results:
                ...
                **No coffee purchase history found.**  
                ...
                for idx, (coffee, recs) in enumerate(results.items(), 1):
                    ...
                    with col_rec2:
                        if recs['flavor']:
                            st.markdown("####  Food Flavor Coupling Rules")
